...
const faqs: FaqItem[] = [
  {
    question: "¿Cuánto tiempo tengo que vivir en Argentina para pedir la ciudadanía?",
    answer:
      "Por naturalización se exigen, en general, 2 años de residencia continua y legal en el país, ser mayor de 18 años, no tener antecedentes penales y acreditar medios lícitos de vida. El trámite se hace ante el Juzgado Federal del domicilio.",
  },
  {
    question: "¿Qué documentos piden para tramitar la residencia?",
    answer:
      "Pasaporte o documento del país de origen, certificado de antecedentes penales y partida de nacimiento apostillados o legalizados, la documentación que acredita el motivo de la residencia y comprobante de domicilio en Argentina.",
  },
  {
    question: "¿Puedo tener doble nacionalidad?",
    answer:
      "Argentina permite la doble nacionalidad: obtener la ciudadanía argentina no implica perder automáticamente la del país de origen, aunque eso depende de la legislación de cada país.",
  },
  {
    question: "¿Qué pasa si mi residencia está vencida?",
    answer:
      "Existen mecanismos de regularización migratoria. Regularizar la situación permite trabajar formalmente, acceder a salud y educación, obtener el DNI para extranjeros y evitar sanciones.",
  },
];
    ...
    <main className="mx-auto min-h-screen w-full max-w-4xl px-6 py-20">
      ...
      <JsonLd
        data={createBreadcrumbSchema([
          ...
          { name: "Migración y residencia en Argentina", path: `/articulos/${article.slug}` },
        ])}
      />
      ...
      <article>
        ...
        <ArticleCta
          title="¿Necesitás regularizar tu situación migratoria o tramitar la ciudadanía argentina?"
          text="Contactá al Estudio LCB para una consulta personalizada. Te asesoramos en cada etapa del trámite para que puedas establecerte legalmente en Argentina con seguridad y tranquilidad."
        />
